...
#
# มีเว้นวรรคหลังทับ เพราะแถวล่าสุดในทะเบียนจริงเป็นแบบนั้น ("ศธ ๐๔๑๔๒.๐๓๕/ 95")
# ถ้าไม่ใส่ แถวใหม่จะหน้าตาไม่เหมือนแถวเก่า
# (ใช้ .strip() ไม่ได้ตรงนี้ เพราะจะกินเว้นวรรคท้ายทิ้ง)
SEND_PREFIX = os.environ.get("SARABAN_SEND_PREFIX") or "ศธ ๐๔๑๔๒.๐๓๕/ "
